...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CDNS_TENSILICA_XTENSA_LX7_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ESP32S3_DEVKITM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_ESP32S3_MINI_N8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESP32S3_RTC_CLK_SRC_INT_RC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESP32S3_RTC_CLK_CAL_CYCLES, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 479);
