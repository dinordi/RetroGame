...
#
# Script generated by Vivado on Sun Mar 10 15:40:40 +0100 2024
...
# script info
echo -e "clk_wiz_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_wiz_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_wiz_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_wiz_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
