...
#                script (type 'Sprite15x15_1.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Sprite15x15_1 xil_defaultlib.glbl -o Sprite15x15_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Sprite15x15_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Sprite15x15_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Sprite15x15_1_simv.daidir vcs_lib c.obj)
