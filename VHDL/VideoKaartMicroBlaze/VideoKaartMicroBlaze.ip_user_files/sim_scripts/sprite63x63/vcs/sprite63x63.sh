...
#                script (type 'sprite63x63.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sprite63x63 xil_defaultlib.glbl -o sprite63x63_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sprite63x63_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sprite63x63_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sprite63x63_simv.daidir vcs_lib c.obj)
