...
#
# Script generated by Vivado on Sun Mar 10 15:10:17 +0100 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sprite63x63.sh
...
#
# Usage        : sprite63x63.sh
#                sprite63x63.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sprite63x63.sh [-reset_run]
#                sprite63x63.sh [-reset_log]
#                sprite63x63.sh [-help]
#
...
# script info
echo -e "sprite63x63.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sprite63x63.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sprite63x63 xil_defaultlib.sprite63x63 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sprite63x63 -key {Behavioral:sim_1:Functional:sprite63x63} -tclbatch cmd.tcl -protoinst "protoinst_files/PmodIPs.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sprite63x63.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sprite63x63.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sprite63x63.sh [-help]\n\
Usage: sprite63x63.sh [-step]\n\
Usage: sprite63x63.sh [-lib_map_path]\n\
Usage: sprite63x63.sh [-reset_run]\n\
Usage: sprite63x63.sh [-reset_log]\n\
Usage: sprite63x63.sh [-keep_index]\n\
Usage: sprite63x63.sh [-noclean_files]\n\n\
