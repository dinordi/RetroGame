...
HD_PWD='C:/progh/VideoKaartMicroBlaze/VideoKaartMicroBlaze.runs/PmodIPs_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodIPs_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodIPs_axi_gpio_0_0.tcl
