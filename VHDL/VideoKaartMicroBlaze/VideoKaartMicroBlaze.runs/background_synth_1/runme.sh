...
HD_PWD='C:/Users/Joey/Downloads/VideoKaartMicroBlaze_third_special_editon/VideoKaartMicroBlaze/VideoKaartMicroBlaze.runs/background_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log background.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source background.tcl
