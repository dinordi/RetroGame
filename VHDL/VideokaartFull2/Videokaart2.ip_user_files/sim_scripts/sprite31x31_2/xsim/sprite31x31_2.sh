...
#
# Script generated by Vivado on Mon Mar 11 16:19:05 +0100 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sprite31x31_2.sh
...
#
# Usage        : sprite31x31_2.sh
#                sprite31x31_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sprite31x31_2.sh [-reset_run]
#                sprite31x31_2.sh [-reset_log]
#                sprite31x31_2.sh [-help]
#
...
# script info
echo -e "sprite31x31_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sprite31x31_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sprite31x31_2 xil_defaultlib.sprite31x31_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sprite31x31_2 -key {Behavioral:sim_1:Functional:sprite31x31_2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sprite31x31_2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sprite31x31_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sprite31x31_2.sh [-help]\n\
Usage: sprite31x31_2.sh [-step]\n\
Usage: sprite31x31_2.sh [-lib_map_path]\n\
Usage: sprite31x31_2.sh [-reset_run]\n\
Usage: sprite31x31_2.sh [-reset_log]\n\
Usage: sprite31x31_2.sh [-keep_index]\n\
Usage: sprite31x31_2.sh [-noclean_files]\n\n\
